"""
TimeExtendModelSMC.py - Time-Extended Multi-Robot Task Assignment Optimization Model
...
<<<<<<< Updated upstream:Models/DynamicModelSMC.py
...
>>>>>>> Stashed changes:Models/TimeExtendModelSMC.py
