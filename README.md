...
- **Time-Extended Model**: Multi-period planning with battery dynamics (TimeExtendSMC.py)
...
│   └── TimeExtendSMC.py      # Multi-period MIP model
├── Data/
...
├── Experiments/
│   └── *.json                # Batch experiment configurations
└── Results/
...
- **Movement Animation**: Shows vehicles executing assignments
  - Orange arrows: Vehicle to Implement
  - Green arrows: Vehicle+Implement to Task
  - Red arrows: Vehicle to Depot
...
- `Models/TimeExtendSMC.py`: Multi-period model
